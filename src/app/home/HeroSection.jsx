...
// _____________________ Responsive _______________________
// "use client";
// import Container from "@/components/Container";
// import React from "react";
// import styles from "@/components/styles/hero.module.css";
...
//   return (
//     <div className={`${styles.image} relative lg:left-[200px] w-full lg:w-[50%]`}>
//       <img
//         src={images[currentSlide]}
//         alt="Hero Image"
...
//   return (
//     <div className="py-16 lg:py-[200px] text-center lg:text-left w-full lg:w-[50%]">
...
//         {content.subtitle}
//       </h1>
//       <p className="mt-4 text-lg md:text-xl lg:text-2xl text-white">{content.description}</p>
//       <div className="mt-7">
...
//   // Auto-change slide every 3 seconds with smooth fade effect
//   useEffect(() => {
...
//   return (
//     <div
//       className={`${styles.image} relative lg:left-[200px] w-full lg:w-[50%] transition-opacity duration-500 ${
...
//   return (
//     <div
//       className={`py-16 lg:py-[200px] text-center lg:text-left w-full lg:w-[50%] transition-opacity duration-500 ${
//         fade ? "opacity-0" : "opacity-100"
//       }`}
//     >
//       <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white">
