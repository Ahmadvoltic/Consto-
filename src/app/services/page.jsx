...
//                         <h1 className='w-full block text-[7vw] font-extrabold leading-none uppercase'>Services </h1>
//                         <h6 className='w-full block opacity-70 '>Small Programs Perfect For Beginners To Get Started With Personal Growth</h6>
//                     </div>
//                 </Container>
//             </div>
//             <Container>
...
//                     <div className="w-1/2 block bg-white p-12  ">
//                         <h4 className="text-[50px] font-extrabold leading-17 mb-3"
//                         >Construction Services</h4>
...
//                         </ul>
//                         <p>
//                             <a href="#" className="inline-block h-[68px] leading-[68px] px-10 bg-black text-white hover:bg-[#feed01] hover:text-black text-[13px] font-semibold transition-all duration-250 ease-in-out"
//                             >GET AN ESTIMATE</a>
//                         </p>
//                     </div>
//                 </Container>
